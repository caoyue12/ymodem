...
#include "../../SerialPortYmodem/YmodemFileTransmit.h"
...
void YmodemFileTransmit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&YmodemFileTransmit::transmitProgress)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&YmodemFileTransmit::transmitStatus)) {
                *result = 1;
                return;
            }
        }
